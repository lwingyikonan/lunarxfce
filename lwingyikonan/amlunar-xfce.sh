...
;;
    ...
    4)
    wget https://raw.githubusercontent.com/lwingyikonan/lunarxfce/main/lwingyikonan/lunarxfce.sh && chmod +x lunarxfce.sh && bash lunarxfce.sh
     ;;
    5)
     cd 
